...
contract Ownable {
    ...
    //getter fun
    function getter_owner() public view returns(address) {
        return _owner;
    }
    ...
    //  3) create an 'onlyOwner' modifier that throws if called by any account other than the owner.
     modifier onlyOwner() {
        require(_owner == msg.sender, "wrong owner");
        _;
    }
...
//  2) create a public setter using the inherited onlyOwner modifier 
      function setterPause(bool newStatus) public onlyOwner {
        _paused = newStatus;
      }
...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
         require(to != ownerOf(tokenId), "not allowed owner");
        // TODO require the given address to not be the owner of the tokenId

        // TODO require the msg sender to be the owner of the contract or isApprovedForAll() to be true
        require(msg.sender == getter_owner() || isApprovedForAll(msg.sender, to), "No authority to approve transfer");
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        // TODO: require from address is the owner of the given token
                require(from == ownerOf(tokenId), "from address is not the owner of given token");


        // TODO: require token is being transfered to valid address
                    require(to != address(0), "token is not being transfered to valid address");
...
contract AbERC721Token is ERC721Metadata {
