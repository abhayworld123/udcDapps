...
contract SupplyChain is Ownable, FarmerRole, DistributorRole, RetailerRole, ConsumerRole{
  ...
  modifier verifyCaller (address _address) {
    require(msg.sender == _address,"verifies caller"); 
    _;
  }

  // Define a modifier that checks if the paid amount is sufficient to cover the price
  modifier paidEnough(uint _price) { 
    require(msg.value >= _price,"not paid sufficient price"); 
    _;
  }
  ...
  function kill() public {
    if (msg.sender == owner()) {
      selfdestruct(owner());   //modified
    }
  }

  // Define a function 'harvestItem' that allows a farmer to mark an item 'Harvested'
  function harvestItem(uint _upc, address _originFarmerID, string _originFarmName, string _originFarmInformation, string  _originFarmLatitude, string  _originFarmLongitude,
